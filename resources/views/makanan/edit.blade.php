...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <form method="post" action="{{route('update-makanan', $makanan->id)}}">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="deskripsi" name="deskripsi" value="{{$makanan->deskripsi}}">
        </div>
        <button type="submit" class="btn btn-primary">Submit</button>
        <a href="{{route('browse-makanan')}}" class="btn btn-danger"> Batal </a>
    </form>
    </div>
    </div>
</body>
