...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <form method="post" action="{{route('update-air', $air->id)}}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="kandang_id" name="kandang_id" value="{{$air->kandang_id}}">
        </div>
        <div class="mb-3">
            <label for="kesehatan_id" class="form-label">Kesehatan</label>
            <input type="text" class="form-control" id="kesehatan_id" name="kesehatan_id" value="{{$air->kesehatan_id}}">
        </div>
        <div class="mb-3">
            <label for="makanan_id" class="form-label">Makanan</label>
            <input type="text" class="form-control" id="makanan_id" name="makanan_id" value="{{$air->makanan_id}}">
        </div>
